...
enum { BOUND_UNKNOWN = 0, BOUND_LOWER = 1, BOUND_UPPER = 2, BOUND_EXACT = 3 };
...
void TTPut(TTEntry* tt, uint64_t hash, int depth, int16_t score, uint8_t bound, Move move, int ply, int16_t eval,
           int pv);
int TTFull();
...
INLINE int TTDepth(TTEntry* e) { return e->depth + DEPTH_OFFSET; }
